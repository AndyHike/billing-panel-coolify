...
export default function ClientEditPage({ params, searchParams }: ClientEditPageProps) {
  const router = useRouter()
  const [loading, setLoading] = useState(false)
  const [error, setError] = useState('')

  // Парсимо дані клієнта з searchParams
  const clientData = searchParams.client ? JSON.parse(decodeURIComponent(searchParams.client)) : null
